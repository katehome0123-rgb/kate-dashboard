...
import re, json, sys
order = ['config','engine','pdf','ui','api','auth','screens/persontable','screens/sales','screens/start','screens/ratio','screens/analysis','screens/profit','screens/cash','screens/maint','screens/incentive','screens/annual','screens/home','main']
...
for m in order:
    ...
    def imp(mm):
        ...
        if mod in ('sales','persontable','start','ratio','analysis','profit','cash','maint','incentive','annual','home'): mod = 'screens/' + mod
        t = name(mod)
