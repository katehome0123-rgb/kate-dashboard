...
import re, json, sys
order = ['config','engine','pdf','ui','api','auth','screens/sales','screens/analysis','screens/profit','screens/cash','screens/maint','screens/incentive','screens/annual','screens/home','main']
...
for m in order:
    ...
    def imp(mm):
        ...
        if mod in ('sales','analysis','profit','cash','maint','incentive','annual','home'): mod = 'screens/' + mod
        t = name(mod)
