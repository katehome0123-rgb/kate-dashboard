...
import re, json, sys
order = ['config','engine','ui','api','auth','screens/sales','screens/analysis','screens/profit','screens/cash','screens/maint','screens/home','main']
...
for m in order:
    ...
    def imp(mm):
        ...
        if mod in ('sales','analysis','profit','cash','maint','home'): mod = 'screens/' + mod
        t = name(mod)
