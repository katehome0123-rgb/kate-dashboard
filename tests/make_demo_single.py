...
import re, json, sys
order = ['config','engine','pdf','ui','api','auth','screens/persontable','screens/sales','screens/start','screens/ratio','screens/map','screens/review','screens/ranking','screens/customers','screens/flyer','screens/leadform','screens/tasks','screens/expense','screens/customerform','screens/deals','screens/analysis','screens/profit','screens/cash','screens/maint','screens/incentive','screens/annual','screens/home','main']
...
for m in order:
    ...
    def imp(mm):
        ...
        if mod in ('sales','persontable','start','ratio','map','review','ranking','customers','flyer','leadform','tasks','expense','customerform','deals','analysis','profit','cash','maint','incentive','annual','home'): mod = 'screens/' + mod
        t = name(mod)
