...
async def main():
    async with async_playwright() as p:
        ...
        for name, vp, scheme in [('desk', (1280, 900), 'light'), ('desk_dark', (1280, 900), 'dark'), ('phone', (390, 844), 'light'), ('fold', (720, 900), 'light')]:
            ...
            for route in ['home', 'sales', 'analysis', 'profit', 'cash', 'maint', 'incentive', 'annual', 'start', 'ratio', 'map', 'review', 'ranking', 'customers', 'flyer', 'leadform', 'tasks', 'expense', 'customerform', 'deals']:
